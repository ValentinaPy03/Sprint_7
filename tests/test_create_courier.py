...
class TestCreateCourier:
    ...
    def test_successful_create_courier(self, generate_courier_data, courier_method):
        ...
        assert courier.status_code == 201 and (courier.json() == AnswerText.TEXT_POST_CREATE_COURIER)
    ...
    def test_create_same_courier(self, courier_method, generate_courier_data):
        ...
        assert courier_2.status_code == 409 and (courier_2.json()['message'] == AnswerText.TEXT_BUG_409_CREATE_COURIER)
    ...
    def test_create_courier_without_required_field(self, courier_method, generate_courier_data_without_required_field):
        ...
        assert courier.status_code == 400 and (courier.json()['message'] == AnswerText.TEXT_BUG_400_CREATE_COURIER)
