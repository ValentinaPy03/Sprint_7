...
class TestLoginCourier:
    ...
    def test_auth_with_non_existent_password(self, courier_method, generate_courier_data):
        ...
        assert courier_log.status_code == 404 and (courier_log.json()['message'] == AnswerText.TEXT_BUG_404_LOG_COURIER)
    ...
    def test_auth_without_login(self, courier_method, generate_courier_data):
        ...
        assert courier_log.status_code == 400 and (courier_log.json()['message'] == AnswerText.TEXT_BUG_400_LOG_COURIER)
